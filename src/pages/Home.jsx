    ...
    <div className="scroll bg-[#161815] bg-[radial-gradient(#ffffff33_1px,#161815_1px)] bg-[size:50px_50px]">
      ...
      <div className="h-screen w-full flex flex-col justify-center items-center">
        <div className="max-w-7xl flex flex-col justify-center items-center w-full roboto gap-y-6">
          <h1 className="text-7xl font-semibold bg-gradient-to-r bg-clip-text text-transparent from-purple-400 to-emerald-400 brightness-150 text-center">
          ...
          <p className="text-center text-[#909090] max-w-2xl text-lg font-sans">
            ...
            earum reiciendis labore facilis nisi vel sint incidunt corporis,
            eos, repellendus placeat impedit illum similique, nihil ipsa nam
            harum repellat amet!
          </p>
          <form>
          ...
          <div className="grid grid-cols-3 w-full px-12 gap-x-12 py-4">
            <div className="bg-neutral-800 text-white rounded-lg px-8 py-6 flex flex-col justify-center">
              ...
              <p className="pt-2 px-2 text-pretty text-sm roboto text-[#909090] ">
                oporte para una extensa variedad de dispositivos mediante la
      ...
      <section className="h-screen w-full mt-20 mb-32">
        <div className="w-11/12 mx-auto h-full bg-slate-50/95 rounded-lg flex flex-col items-center justify-between">
          <span>
      ...
      <section className="h-screen w-full flex flex-col mt-24 text-white">
        <div className="max-w-7xl w-full mx-auto">
          ...
          <div className="divide-x flex">
            <p className="text-lg font-light max-w-2xl px-8 items-center text-pretty">
              ...
              nisi laborum nihil voluptate eligendi delectus quis nobis
              similique quod maiores expedita esse dolor.
            </p>
            <div className="px-8">
